<%@ Control Language="C#" AutoEventWireup="true" CodeFile="UCC_TheLoaiSach.ascx.cs" Inherits="UCC_TheLoaiSach" %>
<style type="text/css">
    .style1
    {
        width: 100%;
